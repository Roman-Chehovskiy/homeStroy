...
<form:form method="post" modelAttribute="estimate" action="allEstimates">
    ...
    <table>
        ...
        <c:forEach var="constructionsEstimate" items="${estimate.constructionList}">
            <tr>
                <td>
    ...
    <output>${estimate.money}</output>
    <form:hidden path="money" value="${estimate.money}"/>
    <br>
    Название
    <form:input path="name" value="${estimate.name}"/>
    ...
    <table>
        <tr>
            <td>
                <input type="submit" formaction="changeEstimate" value="Редактировать">
            </td>
            <td>
